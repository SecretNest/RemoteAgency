...
{
    /// <summary>
    /// Specifies the entity class name which will be generated for holding the response of getting this property. If this attribute absent, the name will be chosen automatically.
    /// </summary>
