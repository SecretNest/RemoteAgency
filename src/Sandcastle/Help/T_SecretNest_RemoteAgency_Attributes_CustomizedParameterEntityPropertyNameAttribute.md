# CustomizedParameterEntityPropertyNameAttribute Class
...
<a href="https://docs.microsoft.com/dotnet/api/system.object" target="_blank">System.Object</a><br />&nbsp;&nbsp;<a href="https://docs.microsoft.com/dotnet/api/system.attribute" target="_blank">System.Attribute</a><br />&nbsp;&nbsp;&nbsp;&nbsp;SecretNest.RemoteAgency.Attributes.CustomizedParameterEntityPropertyNameAttribute<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="T_SecretNest_RemoteAgency_Attributes_CustomizedEventParameterEntityPropertyNameAttribute">SecretNest.RemoteAgency.Attributes.CustomizedEventParameterEntityPropertyNameAttribute</a><br />
...
**VB**<br />
``` VB
Public Class CustomizedParameterEntityPropertyNameAttribute
	Inherits Attribute
```

**C++**<br />
``` C++
public ref class CustomizedParameterEntityPropertyNameAttribute : public Attribute
```

**F#**<br />
``` F#
type CustomizedParameterEntityPropertyNameAttribute =  
    class
        inherit Attribute
    end
```

The CustomizedParameterEntityPropertyNameAttribute type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_SecretNest_RemoteAgency_Attributes_CustomizedParameterEntityPropertyNameAttribute__ctor">CustomizedParameterEntityPropertyNameAttribute</a></td><td>
Initializes an instance of the CustomizedParameterEntityPropertyNameAttribute.</td></tr></table>&nbsp;
<a href="#customizedparameterentitypropertynameattribute-class">Back to Top</a>
...
When this attribute is not present, or <a href="P_SecretNest_RemoteAgency_Attributes_CustomizedParameterEntityPropertyNameAttribute_EntityPropertyName">EntityPropertyName</a> is set to a null reference (`Nothing` in Visual Basic) or empty string, the property name is chosen automatically.

<a href="T_SecretNest_RemoteAgency_Attributes_CustomizedEventParameterEntityPropertyNameAttribute">CustomizedEventParameterEntityPropertyNameAttribute</a> can be marked on event, with higher priority than CustomizedParameterEntityPropertyNameAttribute with the same parameter.
