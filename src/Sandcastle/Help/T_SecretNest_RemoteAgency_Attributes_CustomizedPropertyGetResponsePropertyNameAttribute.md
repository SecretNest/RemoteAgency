# CustomizedPropertyGetResponsePropertyNameAttribute Class
...
<a href="https://docs.microsoft.com/dotnet/api/system.object" target="_blank">System.Object</a><br />&nbsp;&nbsp;<a href="https://docs.microsoft.com/dotnet/api/system.attribute" target="_blank">System.Attribute</a><br />&nbsp;&nbsp;&nbsp;&nbsp;SecretNest.RemoteAgency.Attributes.CustomizedPropertyGetResponsePropertyNameAttribute<br />
...
**VB**<br />
``` VB
Public Class CustomizedPropertyGetResponsePropertyNameAttribute
	Inherits Attribute
```

**C++**<br />
``` C++
public ref class CustomizedPropertyGetResponsePropertyNameAttribute : public Attribute
```

**F#**<br />
``` F#
type CustomizedPropertyGetResponsePropertyNameAttribute =  
    class
        inherit Attribute
    end
```

The CustomizedPropertyGetResponsePropertyNameAttribute type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_SecretNest_RemoteAgency_Attributes_CustomizedPropertyGetResponsePropertyNameAttribute__ctor">CustomizedPropertyGetResponsePropertyNameAttribute</a></td><td>
Initializes an instance of the CustomizedPropertyGetResponsePropertyNameAttribute.</td></tr></table>&nbsp;
<a href="#customizedpropertygetresponsepropertynameattribute-class">Back to Top</a>
...
## Remarks
When this attribute is not present, or <a href="P_SecretNest_RemoteAgency_Attributes_CustomizedPropertyGetResponsePropertyNameAttribute_EntityPropertyName">EntityPropertyName</a> is set to a null reference (`Nothing` in Visual Basic) or empty string, the property name is chosen automatically.
