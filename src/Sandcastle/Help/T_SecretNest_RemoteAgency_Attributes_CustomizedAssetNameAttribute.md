# CustomizedAssetNameAttribute Class
...
<a href="https://docs.microsoft.com/dotnet/api/system.object" target="_blank">System.Object</a><br />&nbsp;&nbsp;<a href="https://docs.microsoft.com/dotnet/api/system.attribute" target="_blank">System.Attribute</a><br />&nbsp;&nbsp;&nbsp;&nbsp;SecretNest.RemoteAgency.Attributes.CustomizedAssetNameAttribute<br />
...
**VB**<br />
``` VB
Public Class CustomizedAssetNameAttribute
	Inherits Attribute
```

**C++**<br />
``` C++
public ref class CustomizedAssetNameAttribute : public Attribute
```

**F#**<br />
``` F#
type CustomizedAssetNameAttribute =  
    class
        inherit Attribute
    end
```

The CustomizedAssetNameAttribute type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_SecretNest_RemoteAgency_Attributes_CustomizedAssetNameAttribute__ctor">CustomizedAssetNameAttribute</a></td><td>
Initializes an instance of the CustomizedAssetNameAttribute.</td></tr></table>&nbsp;
<a href="#customizedassetnameattribute-class">Back to Top</a>
...
## Remarks
When this attribute is not present, or <a href="P_SecretNest_RemoteAgency_Attributes_CustomizedAssetNameAttribute_AssetName">AssetName</a> is set to a null reference (`Nothing` in Visual Basic) or empty string, the asset name is chosen automatically.
