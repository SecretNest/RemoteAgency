# EventParameterTwoWayAttribute Class
...
<a href="https://docs.microsoft.com/dotnet/api/system.object" target="_blank">System.Object</a><br />&nbsp;&nbsp;<a href="https://docs.microsoft.com/dotnet/api/system.attribute" target="_blank">System.Attribute</a><br />&nbsp;&nbsp;&nbsp;&nbsp;<a href="T_SecretNest_RemoteAgency_Attributes_ParameterTwoWayAttribute">SecretNest.RemoteAgency.Attributes.ParameterTwoWayAttribute</a><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;SecretNest.RemoteAgency.Attributes.EventParameterTwoWayAttribute<br />
...
**VB**<br />
``` VB
Public Class EventParameterTwoWayAttribute
	Inherits ParameterTwoWayAttribute
```

**C++**<br />
``` C++
public ref class EventParameterTwoWayAttribute : public ParameterTwoWayAttribute
```

**F#**<br />
``` F#
type EventParameterTwoWayAttribute =  
    class
        inherit ParameterTwoWayAttribute
    end
```

The EventParameterTwoWayAttribute type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_SecretNest_RemoteAgency_Attributes_EventParameterTwoWayAttribute__ctor">EventParameterTwoWayAttribute</a></td><td>
Initializes an instance of EventParameterTwoWayAttribute.</td></tr></table>&nbsp;
<a href="#eventparametertwowayattribute-class">Back to Top</a>
