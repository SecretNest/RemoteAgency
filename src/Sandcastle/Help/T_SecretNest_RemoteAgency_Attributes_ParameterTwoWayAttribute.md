# ParameterTwoWayAttribute Class
...
<a href="https://docs.microsoft.com/dotnet/api/system.object" target="_blank">System.Object</a><br />&nbsp;&nbsp;<a href="https://docs.microsoft.com/dotnet/api/system.attribute" target="_blank">System.Attribute</a><br />&nbsp;&nbsp;&nbsp;&nbsp;SecretNest.RemoteAgency.Attributes.ParameterTwoWayAttribute<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="T_SecretNest_RemoteAgency_Attributes_EventParameterTwoWayAttribute">SecretNest.RemoteAgency.Attributes.EventParameterTwoWayAttribute</a><br />
...
**VB**<br />
``` VB
Public Class ParameterTwoWayAttribute
	Inherits Attribute
```

**C++**<br />
``` C++
public ref class ParameterTwoWayAttribute : public Attribute
```

**F#**<br />
``` F#
type ParameterTwoWayAttribute =  
    class
        inherit Attribute
    end
```

The ParameterTwoWayAttribute type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_SecretNest_RemoteAgency_Attributes_ParameterTwoWayAttribute__ctor">ParameterTwoWayAttribute</a></td><td>
Initializes an instance of ParameterTwoWayAttribute.</td></tr></table>&nbsp;
<a href="#parametertwowayattribute-class">Back to Top</a>
