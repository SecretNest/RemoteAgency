...
namespace SecretNest.RemoteAgency
{
	static class PlainEntityBodyBuilder
	{
		...
		{
			// 方法名：{接口名称}.{set_属性名}
			var methodName = $"{propertyInfo.DeclaringType.Namespace}.{propertyInfo.SetMethod.Name}";
		...
		{
			// 方法名：{接口名称}.{set_属性名}
			var methodName = $"{propertyInfo.DeclaringType.Namespace}.{propertyInfo.GetMethod.Name}";
