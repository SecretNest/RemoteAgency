...
namespace SecretNest.RemoteAgency
{
    ...
    public class EntityBuilding
    {
        ...
        /// <param name="interfaceLevelAttributes">Metadata objects marked with derived class specified by <see cref="EntityTypeBuilderBase.InterfaceLevelAttributeBaseType"/> in interface level. This will be set as <see langword="null"/> when <see cref="EntityTypeBuilderBase.InterfaceLevelAttributeBaseType"/> is set as <see langword="null"/>.</param>
        /// <param name="assetLevelAttributes">Metadata objects marked with derived class specified by <see cref="EntityTypeBuilderBase.AssetLevelAttributeBaseType"/> in asset level. This will be set as <see langword="null"/> when <see cref="EntityTypeBuilderBase.AssetLevelAttributeBaseType"/> is set as <see langword="null"/>.</param>
        /// <param name="delegateLevelAttributes">Metadata objects marked with derived class specified by <see cref="EntityTypeBuilderBase.DelegateLevelAttributeBaseType"/> for the delegate of event. Only available when processing events. This will be set as <see langword="null"/> when <see cref="EntityTypeBuilderBase.DelegateLevelAttributeBaseType"/> is set as <see langword="null"/>.</param>
