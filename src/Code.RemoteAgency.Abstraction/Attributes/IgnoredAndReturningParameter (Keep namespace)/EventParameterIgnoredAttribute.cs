...
namespace SecretNest.RemoteAgency.Attributes
{
    ...
    public sealed class EventParameterIgnoredAttribute : ParameterIgnoredAttribute
    {
        /// <summary>
