...
namespace SecretNest.RemoteAgency.Attributes
{
    ...
    /// <para>When <see cref="IsOneWay"/> is set to <see langword="true"/>, <see cref="ParameterTwoWayAttribute"/>, <see cref="ParameterTwoWayPropertyAttribute"/>, <see cref="EventParameterTwoWayAttribute"/>, <see cref="EventParameterTwoWayPropertyAttribute"/>, <see cref="ReturnIgnoredAttribute"/>, <see cref="CustomizedPropertyGetEntityNameAttribute.ResponseEntityName"/>, <see cref="CustomizedPropertyGetResponsePropertyNameAttribute"/>, <see cref="CustomizedPropertySetEntityNameAttribute.ResponseEntityName"/>, <see cref="CustomizedEntityNameAttribute.ReturnValueEntityName"/>, <see cref="CustomizedEventEntityNameAttribute.RaisingFeedbackEntityName"/>, <see cref="CustomizedReturnValueEntityPropertyNameAttribute"/> and <see cref="OperatingTimeoutTimeAttribute"/> on or in the same asset, and the delegate related to the asset if the asset is an event, will be ignored.</para>
