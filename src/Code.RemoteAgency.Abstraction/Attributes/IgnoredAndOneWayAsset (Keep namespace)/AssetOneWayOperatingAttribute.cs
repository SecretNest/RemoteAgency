...
namespace SecretNest.RemoteAgency.Attributes
{
    ...
    public sealed class AssetOneWayOperatingAttribute : Attribute, IIsOneWay
    {
        /// <inheritdoc />
