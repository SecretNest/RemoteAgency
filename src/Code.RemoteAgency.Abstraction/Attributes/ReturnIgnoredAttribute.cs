...
namespace SecretNest.RemoteAgency.Attributes
{
    ...
    /// </summary>
    /// <remarks>
    /// <para>When <see cref="IsIgnored"/> is set as <see langword="true"/>, the return value of the asset, if exists, will not be sent back the caller.</para>
    ...
    /// <para>When <see cref="IsIgnored"/> is set as <see langword="true"/>, <see cref="CustomizedPropertyGetResponsePropertyNameAttribute"/> and <see cref="CustomizedReturnValueEntityPropertyNameAttribute"/> on or in the same asset, and the delegate related to the asset if the asset is an event, will be ignored.</para>
