...
namespace SecretNest.RemoteAgency.Attributes
{
    ...
    /// </summary>
    /// <remarks>When this attribute is not present, or <see cref="AssetName"/> is set to <see langword="null"/> or empty string, the name of the asset is the same as the name of Method, Event or Property.</remarks>
    ...
    public class CustomizedAssetNameAttribute : Attribute
    {
        ...
        /// </summary>
        /// <param name="assetName">Asset name. Set to <see langword="null"/> or empty string to use the default value. Default name is the same as the name of Method, Event or Property.</param>
