...
namespace SecretNest.RemoteAgency.Attributes
{
    ...
    /// </summary>
    /// <remarks>When this attribute is not present, or <see cref="AssetName"/> is set as <see langword="null"/> or empty string, the asset name is chosen automatically.</remarks>
