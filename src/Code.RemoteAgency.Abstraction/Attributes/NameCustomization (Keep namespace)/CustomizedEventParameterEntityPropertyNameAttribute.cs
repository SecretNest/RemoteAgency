...
namespace SecretNest.RemoteAgency.Attributes
{
    ...
    /// <para>For the parameter is not described by either <see cref="CustomizedEventParameterEntityPropertyNameAttribute"/> or <see cref="CustomizedParameterEntityPropertyNameAttribute"/>, or <see cref="EntityPropertyName"/> is set to <see langword="null"/> or empty string, the property name is chosen automatically.</para>
    /// </remarks>
    ...
    public class CustomizedEventParameterEntityPropertyNameAttribute : Attribute
    {
        ...
        /// </summary>
        /// <remarks><para>If name is set multiple time, the random one other than <see langword="null"/> or empty string is chosen.</para>
        /// <para>When the value is <see langword="null"/> or empty string, name is chosen automatically.</para>
        /// </remarks>
