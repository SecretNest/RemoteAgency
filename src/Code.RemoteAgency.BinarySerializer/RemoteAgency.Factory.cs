...
namespace SecretNest.RemoteAgency
{
    abstract partial class RemoteAgencyBase
    {
        ...
        public static RemoteAgency<byte[]> CreateWithBinarySerializer(Guid? siteId = null)
        {
            return (RemoteAgency<byte[]>)CreateWithoutCheck<byte[], object>(new RemoteAgencyBinarySerializer(), new RemoteAgencyBinarySerializerEntityTypeBuilder(), siteId);
        }
    }
}
