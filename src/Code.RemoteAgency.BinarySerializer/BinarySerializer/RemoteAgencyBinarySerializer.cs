...
namespace SecretNest.RemoteAgency.BinarySerializer
{
    ...
    /// <summary>
    /// Obsoleted class. This class is not present from .net 9 version releases. Provides binary based serializing and deserializing methods for entities.
    /// </summary>
    ...
    public class RemoteAgencyBinarySerializer: SerializingHelperBase<byte[], object>
    {
        ...
        /// <remarks><para>This constructor and this class are not present in Neat release.</para><para>This method is not present from .net 9 version releases.</para></remarks>
        ...
        /// <remarks><para>This method and this class are not present in Neat release.</para><para>This method is not present from .net 9 version releases.</para></remarks>
        public override byte[] Serialize(object original)
        {
