...
{
    static class GetBasicInfoExtensions
    {
        public static RemoteAgencyInterfaceBasicInfo GetBasicInfo(this Type sourceInterface/*, bool includesProxyOnlyInfo*/)
        {
        ...
        static void SetInterfaceTypeBasicInfo(RemoteAgencyInterfaceBasicInfo basicInfo, Type sourceInterface, TypeInfo typeInfo/*, bool includesProxyOnlyInfo*/)
        {
            ...
            basicInfo.ClassNameBase = sourceInterface.GetClassNameBase();
            ...
            basicInfo.ThreadLockMode =
                basicInfo.SourceInterface.GetValueFromAttribute<ThreadLockAttribute, ThreadLockMode>(
                    i => i.ThreadLockMode, out var threadLockAttribute);
        ...
        static string GetClassNameBase(this Type sourceInterface)
        {
