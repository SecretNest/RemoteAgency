...
namespace SecretNest.RemoteAgency.TaskSchedulers
{
    //from https://codereview.stackexchange.com/questions/43814/taskscheduler-that-uses-a-dedicated-thread
    ...
    public class SequentialScheduler : TaskScheduler, IDisposable
    {
        ...
        readonly CancellationTokenSource _cancellation; // CR comment: field added
