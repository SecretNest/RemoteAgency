...
``` VB
<SerializableAttribute>
Public Class AssetNameConflictException
...
``` C++
[SerializableAttribute]
public ref class AssetNameConflictException : public InvalidAttributeDataException
```

**F#**<br />
``` F#
[<SerializableAttribute>]
type AssetNameConflictException =  
    class
        inherit InvalidAttributeDataException
    end
```

The AssetNameConflictException type exposes the following members.
...
<a href="#assetnameconflictexception-class">Back to Top</a>
