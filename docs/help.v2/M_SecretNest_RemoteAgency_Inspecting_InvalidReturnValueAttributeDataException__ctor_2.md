# InvalidReturnValueAttributeDataException Constructor (String, Attribute, MemberInfo, Stack(MemberInfo))
...
new : 
        ...
        attribute : Attribute * 
        memberInfo : MemberInfo * 
        memberParentPath : Stack<MemberInfo> -> InvalidReturnValueAttributeDataException
```
