# InvalidAttributeDataException Constructor (SerializationInfo, StreamingContext)
...
**C#**<br />
``` C#
protected InvalidAttributeDataException(
...
new : 
        ...
        context : StreamingContext -> InvalidAttributeDataException
```
