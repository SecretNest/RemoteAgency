# InvalidParameterAttributeDataException Constructor (SerializationInfo, StreamingContext)
...
**C#**<br />
``` C#
protected InvalidParameterAttributeDataException(
...
new : 
        ...
        context : StreamingContext -> InvalidParameterAttributeDataException
```
