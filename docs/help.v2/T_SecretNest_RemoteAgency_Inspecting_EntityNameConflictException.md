# EntityNameConflictException Class
...
``` VB
<SerializableAttribute>
Public Class EntityNameConflictException
...
``` C++
[SerializableAttribute]
public ref class EntityNameConflictException : public InvalidAttributeDataException
```

**F#**<br />
``` F#
[<SerializableAttribute>]
type EntityNameConflictException =  
    class
        inherit InvalidAttributeDataException
    end
```

The EntityNameConflictException type exposes the following members.
...
<a href="#entitynameconflictexception-class">Back to Top</a>
