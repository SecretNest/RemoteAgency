# InvalidReturnValueAttributeDataException Class
...
``` VB
<SerializableAttribute>
Public Class InvalidReturnValueAttributeDataException
...
``` C++
[SerializableAttribute]
public ref class InvalidReturnValueAttributeDataException : public InvalidAttributeDataException
```

**F#**<br />
``` F#
[<SerializableAttribute>]
type InvalidReturnValueAttributeDataException =  
    class
        inherit InvalidAttributeDataException
    end
```

The InvalidReturnValueAttributeDataException type exposes the following members.
...
<a href="#invalidreturnvalueattributedataexception-class">Back to Top</a>
